    ...
    <div>
      ...
      <div className="min-h-screen flex flex-col items-center bg-gray-50">
        ...
        <div className="flex flex-col items-center mt-10">
          <div
            className="border-dashed border-2 border-gray-400 w-[400px] h-32 flex flex-col items-center justify-center text-gray-500 bg-white rounded-lg cursor-pointer"
